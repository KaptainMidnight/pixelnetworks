...
*/
Route::get('/', [MessagesController::class, 'index'])->name(config('chatify.path'));
 ...
 */
Route::get('/download/{fileName}', [MessagesController::class, 'download'])->name(config('chatify.attachments.route'));
