<div>
    ...
    <div class="h-screen w-full flex antialiased text-white-200 bg-white-900 overflow-hidden">
            ...
            <main class="flex-grow flex flex-row min-h-0">
                <section
                    ...
                    <div class="header p-4 flex flex-row justify-between items-center flex-none">
                        <a href="#"
                           class="block rounded-full hover:bg-white-700 bg-white-800 w-10 h-10 p-2 hidden md:block group-hover:block">
                    ...
                    <div class="search-box p-4 flex-none">
                        <form onsubmit="">
                            <div class="relative">
                                <label>
                                    <input
                                        class="rounded-full py-2 pr-6 pl-10 w-full border border-white-800 focus:border-white-700 bg-white-800 focus:bg-white-900 focus:outline-none text-white-200 focus:shadow-md transition duration-300 ease-in"
                    ...
                    <div class="contacts p-2 flex-1 overflow-y-scroll">
                        <div class="flex justify-between items-center p-3 hover:bg-white-800 rounded-lg relative">
                            ...
                            <div class="flex-auto min-w-0 ml-4 mr-6 hidden md:block group-hover:block">
                                <p>Angelina Jolie</p>
                                <div class="flex items-center text-sm text-white-600">
                                    <div class="min-w-0">
                        ...
                        <div class="flex justify-between items-center p-3 hover:bg-white-800 rounded-lg relative">
                            <div class="w-16 h-16 relative flex flex-shrink-0">
                                <img class="shadow-md rounded-full w-full h-full object-cover"
                                     ...
                                     alt=""
                                />
                                <div class="absolute bg-white-900 p-1 rounded-full bottom-0 right-0">
                            ...
                            <div
                                class="bg-blue-700 w-3 h-3 rounded-full flex flex-shrink-0 hidden md:block group-hover:block"></div>
                        </div>
                        <div class="flex justify-between items-center p-3 bg-white-800 rounded-lg relative">
                            <div class="w-16 h-16 relative flex flex-shrink-0">
                                <img class="shadow-md rounded-full w-full h-full object-cover"
                ...
                <section class="flex flex-col flex-auto border-l border-white-800">
                    <div class="chat-header px-6 py-4 flex flex-row flex-none justify-between items-center shadow">
                        ...
                        <div class="flex">
                            <a href="#" class="block rounded-full hover:bg-white-700 bg-white-800 w-10 h-10 p-2">
                            ...
                            <a href="#" class="block rounded-full hover:bg-white-700 bg-white-800 w-10 h-10 p-2 ml-4">
                                <svg viewBox="0 0 20 20" class="w-full h-full fill-current text-blue-500">
                                    <path
                    ...
                    <div class="chat-body p-4 flex-1 overflow-y-scroll">
                        <div class="flex flex-row justify-start">
                            ...
                            <div class="messages text-sm text-white-700 grid grid-flow-row gap-2">
                                <div class="flex items-center group">
                                    <p class="px-6 py-3 rounded-t-full rounded-r-full bg-white-800 max-w-xs lg:max-w-md text-white-200">
                                        Hey! How are you?</p>
                                    <button type="button"
                                            class="hidden group-hover:block flex flex-shrink-0 focus:outline-none mx-2 block rounded-full text-white-500 hover:text-white-900 hover:bg-white-700 bg-white-800 w-8 h-8 p-2">
...
C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"/>
                                ...
                                <div class="flex items-center group">
                                    <p class="px-6 py-3 rounded-r-full bg-white-800 max-w-xs lg:max-w-md text-white-200">
...
C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"/>
                                ...
                                <div class="flex items-center group">
                                    <p class="px-6 py-3 rounded-b-full rounded-r-full bg-white-800 max-w-xs lg:max-w-md text-white-200">
                                        Lorem ipsum
                                        dolor sit
...
C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"/>
                        ...
                        <p class="p-4 text-center text-sm text-white-500">FRI 3:04 PM</p>
	...
	C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"/>
                        ...
                        <p class="p-4 text-center text-sm text-white-500">SAT 2:10 PM</p>
                        <div class="flex flex-row justify-start">
                            <div class="w-8 h-8 relative flex flex-shrink-0 mr-4">
                                <img class="shadow-md rounded-full w-full h-full object-cover"
                                     src="https://randomuser.me/api/portraits/women/33.jpg"
...
C15.786,7.8,14.8,8.785,14.8,10s0.986,2.2,2.201,2.2S19.2,11.215,19.2,10S18.216,7.8,17.001,7.8z"/>
                        ...
                        <p class="p-4 text-center text-sm text-white-500">12:40 PM</p>
                        <div class="flex flex-row justify-end">
                            <div class="messages text-sm text-white grid grid-flow-row gap-2">
                                <div class="flex items-center flex-row-reverse group">
                                    <p class="px-6 py-3 rounded-t-full rounded-l-full bg-blue-700 max-w-xs lg:max-w-md">
                    ...
                    <div class="chat-footer flex-none">
                        <div class="flex flex-row items-center p-4">
                            ...
                            <div class="relative flex-grow">
                                <label>
                                    <input
                                        class="rounded-full py-2 pl-3 pr-10 w-full border border-white-800 focus:border-white-700 bg-white-800 focus:bg-white-900 focus:outline-none text-white-200 focus:shadow-md transition duration-300 ease-in"
